...
test.beforeAll(async () => {
  ...
  // Wait until the app has fully loaded (title and body settle after networkidle)
  await mainWindow.waitForLoadState("networkidle");
  // Wait for Node-RED admin UI to finish initializing: title transitions
  // from "Loading <url>" to the final app title set by the renderer.
